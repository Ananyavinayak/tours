		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#BF40BF">SS Travel Agency</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 9481383537&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+91) 8317428672</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">sstravels@gmail.com&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Channasandra Banglore.</h5>
                        <br/>
...
/*if(!empty($_POST["send"])) {
	...
	$toEmail = "shreeraksha@gmail.com.com";
...
mysqli_query($conn, "INSERT INTO message (name, contact,email,message) VALUES ('" . $name. "', '" . $contact. "','" . $email. "','" . $message. "')");
